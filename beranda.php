...
<body>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="http://bola.okezone.com/read/2016/11/17/51/1543805/daftar-22-pemain-timnas-indonesia-di-piala-aff-2016" title='timnas indonesia'><b>Timnas Indonesia</b></a>
            ...
            <a class="navbar-brand">|</a>
			<a class="navbar-brand" href="logout.php"><b><u>LOG OUT</u></b></a>
        </div>
...
<div class="container">
		<div class="content">
		  <h2>Data Pemain</h2>
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						echo '
							...
							<td>
								...
								<a href="beranda.php?aksi=delete&userName='.$row['userName'].'" title="Hapus Data" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['userName'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
						$no++;
			...
			<form method="post" action="reportdata.php">
  			<table>
  				<tr>
  				<td><input type="submit" name="Submit" value="Tampilkan Laporan" /></td>
  			</tr>
  	</table>
  	<p>&nbsp;</p>
  <p>&nbsp; </p>
